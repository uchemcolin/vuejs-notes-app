    ...
    <div v-if="!tryingToLoadNotes">
      ...
      <div class="notes-list" v-else>
        <div class="note-card">
          ...
          <div v-else="showLoadingErrorMessage.value == true">
            <div style="color: red;">
              <div><strong>Error loading notes. Please try again.</strong></div>
              <div>
                <RouterLink to="/">Reload</RouterLink>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="loading" v-else>
      <div class="notes-list">
        <div class="note-card">
          ...
          <div v-else="showLoadingErrorMessage == true">
            <div style="color: red;">
